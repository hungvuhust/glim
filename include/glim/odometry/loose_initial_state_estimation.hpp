...
template <typename VoxelContents> class IncrementalVoxelMap;
...
public:
  ...
  virtual void
  insert_frame(const PreprocessedFrame::ConstPtr &raw_frame) override;
  virtual void insert_imu(double stamp, const Eigen::Vector3d &linear_acc,
